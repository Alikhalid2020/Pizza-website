...
$(document).ready(function () {
  ...
  $("#checkout-form").submit(function (e) {
    ...
    if (deliveryOption === "deliver") {
      ...
      alert(customerName + ": Your total bill is Ksh. " + totalCost + ". Your order will be ready for collection in the next 30 min" );
    }
  });
  $("#location-form").submit(function (e) {
    ...
    $(".location").hide();
    alert(customerName + ": Your total bill is Ksh. " + totalCost + ". Your order will be delivered to "+ estate + ", " + houseNumber +" in the next 1 hour." );
  });
});